...
<head>
    ...
    <title>Upload Buku Baru - Admin Kanca Tegal</title>
    ...
    <div class="admin-content">
        ...
        <div class="page-header">
            <div class="page-title-group">
                ...
                <h1 class="page-title">Upload Buku<br>Baru</h1>
            </div>
        ...
        <!-- Book upload form -->
        <form action="{{ url('/admin/buku/store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-container">
                ...
                <div class="cover-upload-card">
                    ...
                    <div class="image-preview-wrapper" onclick="document.getElementById('fotoInput').click();">
                        ...
                        <input type="file" name="foto" id="fotoInput" class="file-input @error('foto') is-invalid @enderror" accept="image/*" required>
                    </div>
                    @error('foto')
                ...
                <div class="form-details-card">
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="judul" id="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul') }}" placeholder="Contoh: Sang Pemimpi" required>
                            @error('judul')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_halaman" id="jumlah_halaman" class="form-control @error('jumlah_halaman') is-invalid @enderror" value="{{ old('jumlah_halaman') }}" min="1" placeholder="Contoh: 292" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="isbn" id="isbn" class="form-control @error('isbn') is-invalid @enderror" value="{{ old('isbn') }}" placeholder="Contoh: 978-602-291-292-7" required>
                            @error('isbn')
                                <span class="input-error-msg">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="bahasa" id="bahasa" class="form-control @error('bahasa') is-invalid @enderror" required>
                                ...
                                <option value="Jawa / Tegalan" {{ old('bahasa') == 'Jawa / Tegalan' ? 'selected' : '' }}>Jawa / Tegalan</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status_publish" id="status_publish" class="form-control @error('status_publish') is-invalid @enderror" required>
                                <option value="publish" {{ old('status_publish', 'publish') == 'publish' ? 'selected' : '' }}>PUBLISH</option>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="sinopsis" id="sinopsis" class="form-control @error('sinopsis') is-invalid @enderror" placeholder="Tuliskan sinopsis singkat mengenai isi buku ini..." required>{{ old('sinopsis') }}</textarea>
                            @error('sinopsis')
                                <span class="input-error-msg">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="tentang_penulis" id="tentang_penulis" class="form-control @error('tentang_penulis') is-invalid @enderror" placeholder="Tulis biografi singkat atau latar belakang penulis buku ini...">{{ old('tentang_penulis') }}</textarea>
