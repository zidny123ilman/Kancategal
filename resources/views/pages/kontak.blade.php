...
<head>
    ...
    <!-- Meta Tags SEO -->
    <meta name="description" content="Hubungi komunitas Kanca Tegal melalui WhatsApp, email resmi, atau ikuti jejak digital kami di Instagram, TikTok, dan Twitter.">
    ...
    <main class="contact-page-container">
        ...
        <div class="contact-title-wrapper">
            <div class="contact-title-left">
                ...
                <p class="contact-main-desc">
                    "Curating conversations, archiving ideas. Join the collective and let's bridge the literacy gap together."
                </p>
            </div>
        ...
        <div class="contact-grid">
            ...
            <div class="contact-card mint-card">
                ...
                <button class="btn-copy-address" onclick="navigator.clipboard.writeText('kancategal10@gmail.com'); alert('Alamat email berhasil disalin!');">
        ...
        <div class="contact-grid-bottom">
            ...
            <div class="books-photo-card">
                <img src="https://images.unsplash.com/photo-1543002588-bfa74002ed7e?auto=format&fit=crop&q=80&w=500" alt="Vintage books stack" class="books-photo-img">
                <div class="books-photo-overlay">
                    <h4 class="photo-overlay-title">The Modern Archivist.</h4>
                    <span class="photo-overlay-subtitle">EST. 2024</span>
                </div>
            </div>
